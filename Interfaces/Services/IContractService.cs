...
namespace NhaTro.Interfaces.Services
{
    ...
    {
        Task<List<ContractDto>> GetAllAsync(string? status = null, int? roomId = null, bool includeArchived = false);
        ...
        Task<ContractDto?> CancelAsync(int contractId, CancelContractDto dto);
