namespace NhaTro.Services
{
    public class AssistantTrainingPhraseCatalog
    {
        ...
        private static readonly IReadOnlyDictionary<string, string[]> CorePhrases = new Dictionary<string, string[]>
        {
            ...
            [AssistantActionRegistry.MeterReadingsFindAll] = new[] { "danh sách chỉ số điện tháng 10", "lịch sử công tơ phòng A1" },
            [AssistantActionRegistry.MeterReadingsFindById] = new[] { "xem chỉ số điện ID 8", "chi tiết bản ghi công tơ số 8" },
            [AssistantActionRegistry.MeterReadingsDeleteByEndedContract] = new[] { "xóa toàn bộ chỉ số hợp đồng đã kết thúc phòng A1", "dọn số điện của hợp đồng cũ" },
            ...
            [AssistantActionRegistry.RoomsFindById] = new[] { "xem phòng ID 3", "chi tiết phòng có ID 3" },
            ...
            [AssistantActionRegistry.TenantsFind] = new[] { "xem thông tin khách Hùng", "tìm khách thuê ID 5" },
            ...
            [AssistantActionRegistry.ContractsFindById] = new[] { "xem hợp đồng ID 5", "chi tiết hợp đồng số 5" },
            ...
            [AssistantActionRegistry.InvoicesFindByPaymentCode] = new[] { "tra hóa đơn theo mã thanh toán", "xem mã thanh toán HD-A1-202610" },
            [AssistantActionRegistry.InvoicesFindById] = new[] { "xem hóa đơn ID 12", "chi tiết hóa đơn số 12" },
            [AssistantActionRegistry.InvoicesCreate] = new[] { "tạo hóa đơn tháng 10 cho phòng A1", "lập hóa đơn riêng phòng A1" },
            ...
            [AssistantActionRegistry.TransactionsFindById] = new[] { "xem giao dịch thu chi ID 15", "chi tiết khoản thu số 15" },
            ...
            [AssistantActionRegistry.PaymentsFindById] = new[] { "xem chuyển khoản ngân hàng ID 5", "chi tiết giao dịch ngân hàng số 5" },
            ...
            [AssistantActionRegistry.ReportsSalesLedger] = new[] { "xem sổ doanh thu từ tháng 1 đến tháng 6", "sổ bán hàng nửa đầu năm" },
            [AssistantActionRegistry.ReportsSalesLedgerPdf] = new[] { "xuất PDF sổ doanh thu từ tháng 1 đến tháng 6", "tải sổ bán hàng PDF" }
        };
