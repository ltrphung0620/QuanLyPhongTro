namespace NhaTro.Services
{
    public class AssistantToolRegistry
    {
        ...
        public string BuildPromptCatalog(string? role)
        {
            ...
            if (role == "Tenant")
            {
                ...
                allowedTools = Tools.Where(t => tenantAllowedIntents.Contains(t.Name)).ToList();
            }
            else if (role == "SuperAdmin")
            {
                allowedTools = Array.Empty<AssistantToolDefinition>();
            }

            return string.Join("\n", allowedTools.Select(tool =>
            {
        ...
        private static string GetRiskLevel(string intent, bool requiresConfirmation)
        {
            return intent switch
            {
                ...
                AssistantActionRegistry.MeterReadingsDeleteByEndedContract => AssistantToolRiskLevels.High,
        ...
        private static string[] GetOptionalFields(string intent)
        {
            return intent switch
            {
                ...
                AssistantActionRegistry.InvoicesCreate => new[] { "discountAmount", "debtAmount" },
        ...
        private static string GetParameterType(string name)
        {
            return name switch
            {
                ...
                "currentReading" or "occupantCount" or "roomId" or "invoiceId" or "contractId" or "tenantId"
        ...
        private static string GetParameterDescription(string name)
        {
            return name switch
            {
                ...
                "fromMonth" => "First month in a report range.",
                "toMonth" => "Last month in a report range.",
        ...
        private static string GetOutputDescription(string intent)
        {
            return intent switch
            {
                ...
                AssistantActionRegistry.MeterReadingsFindAll => "List of meter readings.",
                AssistantActionRegistry.MeterReadingsFindById => "Meter reading detail.",
                ...
                AssistantActionRegistry.RoomsFindById => "Room detail.",
                AssistantActionRegistry.RoomsCreate => "Preview or created room.",
                AssistantActionRegistry.TenantsFindAll => "List of tenants.",
                AssistantActionRegistry.TenantsFind => "Tenant detail or matching tenant choices.",
                ...
                AssistantActionRegistry.ContractsFindById => "Contract detail.",
                ...
                AssistantActionRegistry.InvoicesFindByPaymentCode => "Invoice detail resolved by payment code.",
                AssistantActionRegistry.InvoicesFindById => "Invoice detail.",
                AssistantActionRegistry.InvoicesCreate => "Preview or created invoice for one room.",
                ...
                AssistantActionRegistry.TransactionsFindById => "Income or expense transaction detail.",
                ...
                AssistantActionRegistry.MeterReadingsDeleteByEndedContract => "Preview or bulk meter reading deletion result.",
                ...
                AssistantActionRegistry.PaymentsFindById => "Bank payment transaction detail.",
                ...
                AssistantActionRegistry.ReportsSalesLedger => "Sales ledger rows and total.",
                AssistantActionRegistry.ReportsSalesLedgerPdf => "Generated sales ledger PDF metadata and content.",
                _ => "Tool result."
            };
        }
