...
namespace NhaTro.Migrations
{
    ...
    [Migration("20260809154234_AddSupportMessageImageData")]
    partial class AddSupportMessageImageData
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NhaTro.Models.AdminOrganizationMembership", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<bool>("CanAccessAllPages")
                        .HasColumnType("bit")
                        .HasColumnName("can_access_all_pages");
                    ...
                    b.ToTable("admin_organization_memberships", (string)null);
                });

            modelBuilder.Entity("NhaTro.Models.AdminOrganizationPagePermission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("admin_organization_page_permissions", (string)null);
                });
            ...
            modelBuilder.Entity("NhaTro.Models.SupportConversation", b =>
                {
                    b.Property<int>("SupportConversationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasColumnName("support_conversation_id");
            ...
            modelBuilder.Entity("NhaTro.Models.SupportMessage", b =>
                {
                    ...
                    b.HasIndex("SupportConversationId", "ReadAt");

                    b.HasIndex("SupportConversationId", "SupportMessageId");
            ...
            modelBuilder.Entity("NhaTro.Models.AdminOrganizationMembership", b =>
                {
                    ...
                    b.HasOne("NhaTro.Models.AppUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("NhaTro.Models.SupportConversation", b =>
                {
                    b.HasOne("NhaTro.Models.AppUser", "AdminUser")
                        .WithMany()
            ...
            modelBuilder.Entity("NhaTro.Models.SupportMessage", b =>
                {
                    b.HasOne("NhaTro.Models.AppUser", "SenderUser")
                        .WithMany()
                        .HasForeignKey("SenderUserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("NhaTro.Models.SupportConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("NhaTro.Models.AppUser", b =>
                {
                    ...
                    b.Navigation("DepositSettlements");
